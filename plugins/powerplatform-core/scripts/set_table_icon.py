#!/usr/bin/env python3
"""Set Dataverse table icon metadata with the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Set Dataverse table icon metadata through the shared SDK metadata helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the icon update.")
