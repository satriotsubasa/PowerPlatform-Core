#!/usr/bin/env python3
"""Create a Dataverse security role through the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create a Dataverse security role through the shared SDK helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the security role to create.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before creating the security role.")
