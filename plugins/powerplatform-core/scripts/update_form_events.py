#!/usr/bin/env python3
"""Register Dataverse form libraries and event handlers with the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Register Dataverse form libraries and form event handlers through the shared SDK metadata helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the form event update.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before updating form events.")
