#!/usr/bin/env python3
"""Create a Dataverse table with the shared SDK metadata helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create a Dataverse table through the shared SDK metadata helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the table.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before creating the table.")
