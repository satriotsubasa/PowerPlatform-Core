#!/usr/bin/env python3
"""Build and first-register a Dataverse plug-in assembly and steps headlessly."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build and first-register a Dataverse plug-in assembly and steps headlessly.",
    )
    ...
    parser.add_argument("--plugin-file", help="Assembly DLL to register. Inferred from the project when omitted.")
    ...
    plugin_file = Path(args.plugin_file).resolve() if args.plugin_file else infer_plugin_assembly_file(
        project_path,
