#!/usr/bin/env python3
"""Create a Dataverse custom API with the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create a Dataverse custom API through the shared SDK helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the custom API.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before creating the custom API.")
