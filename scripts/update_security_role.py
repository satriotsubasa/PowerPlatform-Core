#!/usr/bin/env python3
"""Update a Dataverse security role through the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Update a Dataverse security role through the shared SDK helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the security role update.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before updating the security role.")
