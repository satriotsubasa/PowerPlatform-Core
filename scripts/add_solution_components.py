#!/usr/bin/env python3
"""Add resolved components to a Dataverse solution through the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Add Dataverse components to a target solution through the shared SDK solution helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the solution components.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before adding components.")
