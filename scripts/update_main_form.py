#!/usr/bin/env python3
"""Update a Dataverse main form layout with the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Update a Dataverse main form layout through the shared SDK metadata helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the form update.")
