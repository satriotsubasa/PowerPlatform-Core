#!/usr/bin/env python3
"""Set a Dataverse environment variable value through the shared SDK helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Set a Dataverse environment variable value through the shared SDK helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the environment variable value change.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before setting the environment variable value.")
