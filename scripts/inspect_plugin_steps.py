#!/usr/bin/env python3
"""Inspect Dataverse plug-in steps for an existing assembly or package."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Inspect Dataverse plug-in steps for an existing assembly or package.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the step inspection request.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before inspecting plug-in steps.")
