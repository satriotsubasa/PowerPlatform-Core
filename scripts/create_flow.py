#!/usr/bin/env python3
"""Create a solution-aware cloud flow through the shared Dataverse SDK helper."""
...
from power_automate_common import prepare_flow_spec
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Create a solution-aware cloud flow through the shared Dataverse SDK helper.",
    )
    parser.add_argument("--spec", required=True, help="JSON object or path to a JSON file describing the flow.")
    ...
    parser.add_argument("--auth-dialog", action="store_true", help="Launch the reusable auth dialog before creating the flow.")
